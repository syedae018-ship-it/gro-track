...
function Shimmer({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "rounded-xl bg-card/[0.04] animate-pulse",
        className
      )}
    />
  )
  ...
  return (
    <div className={`grid grid-cols-2 md:grid-cols-${Math.min(count, 4)} gap-4`}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="p-4 rounded-xl border border-border bg-card/[0.02] flex flex-col gap-3">
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-card/[0.02] border border-border rounded-xl p-5 flex flex-col gap-4">
        ...
        <div className="lg:col-span-2 bg-card/[0.02] border border-border rounded-xl overflow-hidden">
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        {[0, 1].map(col => (
          <div key={col} className="bg-muted/30 border border-border rounded-2xl overflow-hidden min-h-[400px]">
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-card/[0.03] border border-border rounded-xl p-4 flex flex-col gap-1.5">
...
export function PaymentsSkeleton() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="bg-card/[0.02] border border-border rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-border">
          <Shimmer className="w-40 h-5" />
        </div>
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="px-5 py-3 flex items-center gap-4 border-b border-border">
...
export function SettingsSkeleton() {
  return (
    <div className="flex flex-col gap-6 w-full max-w-2xl mx-auto">
      ...
      <div className="bg-card/[0.02] border border-border rounded-xl p-6 flex flex-col gap-5">
        {/* Avatar */}
        <div className="flex items-center gap-4">
