...
export function StatCard({ title, value, icon, trend, delay = 0 }: StatCardProps) {
  return (
    <motion.div 
      ...
      className="p-6 glass-card flex flex-col gap-4 relative overflow-hidden group"
    >
      ...
      <div className="flex items-center gap-2 relative z-10">
        <div className="w-9 h-9 rounded-full bg-input border border-border shadow-luxury-glow flex items-center justify-center text-primary">
          {icon}
        </div>
      ...
      <div className="flex items-end gap-3 relative z-10">
        ...
        {trend && (
          <span className={`text-sm font-medium mb-1 ${trend.isPositive ? 'text-emerald-400 drop-shadow-[0_0_8px_rgba(52,211,153,0.5)]' : 'text-rose-400 drop-shadow-[0_0_8px_rgba(244,63,94,0.5)]'}`}>
