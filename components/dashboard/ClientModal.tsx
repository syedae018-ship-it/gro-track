...
export function ClientModal() {
 ...
 <h2 className="text-xl font-bold text-foreground mb-4">Create New Client</h2>
 ...
 <input required name="name" className="w-full bg-muted border border-border rounded p-2 text-foreground" />
 </div>
 <div className="space-y-2">
 <label className="text-sm text-secondary">Industry</label>
 <input name="industry" className="w-full bg-muted border border-border rounded p-2 text-foreground" />
 </div>
 <div className="space-y-2">
 <label className="text-sm text-secondary">Contact Email</label>
 <input type="email" name="contact_email" className="w-full bg-muted border border-border rounded p-2 text-foreground" />
 </div>
 <div className="space-y-2">
 <label className="text-sm text-secondary">Status</label>
 <select name="status" className="w-full bg-muted border border-border rounded p-2 text-foreground">
