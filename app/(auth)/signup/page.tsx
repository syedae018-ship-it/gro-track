...
export default function SignupPage({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row overflow-hidden relative font-sans">
      ...
      {/* ── LEFT SIDE — Branding ── */}
      <div className="hidden md:flex flex-col flex-1 relative bg-[#090014] p-12 justify-between border-r border-primary/20 overflow-hidden">
        {/* Ambient Glows */}
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-primary shadow-luxury-glow flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-md my-auto">
          ...
          <h2 className="text-[38px] font-syne font-bold text-foreground mb-6 leading-tight tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-primary">operational</span>{" "}
            flow.
          </h2>
          <div className="space-y-4">
            {[
              ...
              <div key={feature} className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-primary/15 border border-primary/30 shadow-luxury-glow flex items-center justify-center shrink-0">
                  <Check className="w-3.5 h-3.5 text-primary" />
                </div>
                <span className="text-sm text-[#b8a9d9]">{feature}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── RIGHT SIDE — Form ── */}
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-12 relative overflow-y-auto bg-[#05010d]">
        {/* Ambient glow */}
          ...
          {verificationEmail ? (
            ...
            <div className="flex flex-col items-center text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="relative">
                ...
                <div className="relative w-20 h-20 rounded-2xl bg-surface border border-primary/30 shadow-purple-bloom flex items-center justify-center text-primary">
              ...
              <div className="w-full pt-4 space-y-3 border-t border-border">
                <button
                  ...
                  className="w-full h-12 rounded-full border border-primary/40 bg-primary/10 text-primary text-sm font-semibold hover:bg-primary/20 hover:shadow-luxury-glow transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                ...
                <Link href="/login" className="block">
                  <button className="w-full h-12 rounded-full bg-surface border border-border text-muted-foreground text-sm font-medium hover:text-primary hover:border-primary/40 transition-all flex items-center justify-center gap-2">
            ...
            <div className="animate-in fade-in duration-500">
              ...
              {/* Glowing card */}
              <div className="relative">
                <div className="absolute inset-[-1px] rounded-[28px] bg-gradient-primary opacity-20 blur-sm pointer-events-none" />
                <div className="relative bg-surface backdrop-blur-[20px] rounded-[24px] p-8 border border-primary/25 shadow-purple-bloom">
                  ...
                  <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full h-12 bg-input border border-border rounded-full px-5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/50 transition-all disabled:opacity-50"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        required
                        disabled={isLoading}
                        className="w-full h-12 bg-input border border-border rounded-full px-5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/50 transition-all appearance-none disabled:opacity-50 cursor-pointer"
                      >
                        <option value="employee" className="bg-[#120424] text-foreground">Employee</option>
                        <option value="admin_ops" className="bg-[#120424] text-foreground">Admin (Ops)</option>
                        <option value="admin_finance" className="bg-[#120424] text-foreground">Admin (Finance)</option>
                        <option value="managing_director" className="bg-[#120424] text-foreground">Admin (Managing Director)</option>
                      </select>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full h-13 mt-2 rounded-full bg-gradient-primary text-[14px] font-bold text-white hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed shadow-purple-bloom hover:shadow-[0_0_50px_rgba(139,92,246,0.7)] border border-primary/30 py-3.5"
                    >
                      {isLoading ? (
